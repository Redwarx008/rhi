...
namespace rhi::impl
{
    ...
    public:
        ...
        void BufferUsedAs(BufferBase* buffer, BufferUsage usage, ShaderStage shaderStages = ShaderStage::None);
        void TextureViewUsedAs(TextureViewBase* view, TextureUsage usage, ShaderStage shaderStages = ShaderStage::None);
