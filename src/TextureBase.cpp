...
TextureBase::~TextureBase() = default;
    ...
    TextureViewBase::TextureViewBase(TextureBase* texture, const TextureViewDesc& desc) :
        ...
        mDimension(desc.dimension),
        mFormat(desc.format),
        mRange(ViewAspectConvert(desc.format, desc.aspect),
               desc.baseArrayLayer,
    ...
    static const FormatInfo c_FormatInfo[] = {
            ...
            {TextureFormat::D32_UNORM,
             ...
             false,
             FormatComponentType::Undefined},
            {TextureFormat::D32_UNORM_S8_UINT,
             "D32_UNORM_S8_UINT",
             8,
             1,
             false,
